...
class Signal_Detector:
    ...
    def img_callback(self,msg): 
        image = self.bridge.imgmsg_to_cv2(msg, "passthrough")[self.cut_y[0]:self.cut_y[1],self.cut_x[0]:self.cut_x[1]]
        # gray_image = cv2.cvtColor(image , cv2.COLOR_BGR2GRAY)
        # _,msk = cv2.threshold(gray_image,75,255, cv2.THRESH_BINARY)
        ...
        # self.image_raw = msk
        self.image_canny_pub.publish(self.bridge.cv2_to_imgmsg(image))
